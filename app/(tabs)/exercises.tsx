...
const styles = StyleSheet.create({
  ...
  addBtn: { paddingHorizontal: theme.spacing.md, paddingVertical: theme.spacing.sm, backgroundColor: theme.colors.cardWarm, borderRadius: theme.radius.full, ...theme.shadow.soft },
  addBtnText: { fontSize: theme.fontSize.sm, fontFamily: theme.fonts.bodySemiBold, color: theme.colors.accent },
  search: { marginHorizontal: theme.spacing.md, marginBottom: theme.spacing.sm, height: 44, backgroundColor: theme.colors.card, borderRadius: theme.radius.md, paddingHorizontal: theme.spacing.md, color: theme.colors.text, fontFamily: theme.fonts.body, ...theme.shadow.soft },
  ...
  filterChip: { paddingHorizontal: theme.spacing.md, paddingVertical: theme.spacing.xs, borderRadius: theme.radius.full, backgroundColor: theme.colors.card, ...theme.shadow.soft },
  filterChipActive: { backgroundColor: theme.colors.accentSoft },
  filterChipText: { fontSize: theme.fontSize.sm, fontFamily: theme.fonts.bodyMedium, color: theme.colors.text },
  filterChipTextActive: { color: theme.colors.text, fontFamily: theme.fonts.bodyBold },
  list: { paddingHorizontal: theme.spacing.md, paddingBottom: 40 },
  groupHeading: { fontSize: theme.fontSize.sm, fontFamily: theme.fonts.bodyBold, color: theme.colors.accent, textTransform: 'uppercase', letterSpacing: 1, marginTop: theme.spacing.lg, marginBottom: theme.spacing.sm },
  ...
  modalTitle: { fontSize: theme.fontSize.xl, fontFamily: theme.fonts.display, color: theme.colors.text, marginBottom: theme.spacing.lg },
