...
const styles = StyleSheet.create({
  ...
  durationText: { fontSize: theme.fontSize.sm, fontFamily: theme.fonts.bodyMedium, color: theme.colors.textMuted },
  durationTextActive: { color: '#FFFFFF', fontFamily: theme.fonts.bodyBold },
  dismissBtn: {
    paddingVertical: theme.spacing.sm,
